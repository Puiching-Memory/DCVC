...
python tensorRT/tools/export_cdf.py
python tensorRT/tools/convert_weights.py
python tensorRT/tools/build_engines.py
python tensorRT/tools/dump_golden.py   # needs CUDA
```
